...
// $command = "zFeedback Register Op: ex Path: /Event/InfoResult/info/callin_country_list" ;
// echo "---------- running command: {$command}\n" ;
// echo run_interactive_command( $shell, $command ) ;

// $command = "zFeedback Register Op: ex Path: /Event/InfoResult/info/toll_free_callin_list" ;
// echo "---------- running command: {$command}\n" ;
// echo run_interactive_command( $shell, $command ) ;

$command = "zcommand call info" ;
echo "---------- running command: {$command}\n" ;
echo run_interactive_command( $shell, $command, '"InfoResult":', 2 ) ;
